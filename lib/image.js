...
module.exports = function(src) {
  ...
  switch (this.type) {
    case 'jpeg':
      ...
      break
    case 'png':
      this.info = parsePNGInfo(this.src)
      this.width = this.info.width
      this.height = this.info.height
      // TODO: add proper support for png color spaces.
      this.info.colorSpace = 3
      this.colorSpace = 'DeviceRGB'
      break
    case 'pdf':
...
function parsePNGInfo(arrayBuffer) {
  // TODO: add proper support for png color spaces.
  // See https://en.wikipedia.org/wiki/Portable_Network_Graphics#Critical_chunks
  //     http://stackoverflow.com/a/20001230/192217
...
function hasPNGSigature(arrayBuffer) {
